...
function login_header($title = 'Log In', $message = '', $wp_error = '') {
	...
	<div id="login">
			...
			<a class="login-link" href="<?php echo esc_url( $login_header_url ); ?>" title="<?php echo esc_attr( $login_header_title ); ?>" style="background:none !important;">
				<img style="width:558px; height:210px;" src="/wp-content/images/header/BOR_Facebook_Header.png" />
			</a>
