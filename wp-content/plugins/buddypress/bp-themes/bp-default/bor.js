$(document).ready(function() {
	...
	$('#cloud').animate({'margin-left':100}, 5000);

	$('.simple-font').click(function() {
		if ($(this).html() == 'View Story in Simple Font') {
			$('.post .post-content .entry').css({'font-family':'arial'});
			$(this).html('Back to Original Font');
		} else {
			$('.post .post-content .entry').css({'font-family':'Apple Chancery'});
			$(this).html('View Story in Simple Font');
		}
	});
